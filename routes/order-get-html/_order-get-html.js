					...
					for(var i=0; i<result[0].decks.length; i++) {
						if(request.query.get_type == "view"){
							...
							"<tr data-id='"+result[0].decks[i].id+"' class='order_table_row'>"+
								...
								"<td class='price_listing import_table export_table'><input type='number' class='browser-default input-table' name='cross.invoice' value='"+result[0].decks[i].cross.invoice+"'></td>"+
								...
								"<td class='price_listing import_table export_table national_table'><input type='number' class='browser-default input-table' name='carrierMX.invoice' value='"+result[0].decks[i].carrierMX.invoice+"'></td>"+
								...
								"<td class='price_listing import_table export_table'><input type='number' class='browser-default input-table' name='carrierUS.invoice' value='"+result[0].decks[i].carrierUS.invoice+"'></td>"+
								...
								"<td class='price_listing import_table export_table'><input type='number' class='browser-default input-table' name='transfer.invoice' value='"+result[0].decks[i].transfer.invoice+"'></td>"+
								...
								"<td class='price_listing import_table export_table'><input type='number' class='browser-default input-table' name='local.invoice' value='"+result[0].decks[i].local.invoice+"'></td>"+
